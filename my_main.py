...
if __name__ == "__main__":
    ...
    for experiment in range(0, N):
        ...
        print_save_results(args, results1, root, i, time, PRETRAIN)
        ...
        print_save_results(args, results2, root, i, time, YNET)
        ...
        print_save_results(args, results3, root, i, time, BASELINE)
        i += 1

...
def create_model(args, device):
    ...
    if args.model == 'vgg16':
        ...
        if args.pretrained:
            model = model = _resnet('resnet50', Bottleneck, [3, 4, 6, 3], pretrained=True, progress=True)
        else:
            model = model = _resnet('resnet50', Bottleneck, [3, 4, 6, 3], pretrained=False, progress=True)
